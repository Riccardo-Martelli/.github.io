...
document.addEventListener('click', function(event) {
  ...
  function getPrice(sentence) {
      switch (sentence.trim()) {
          ...
          case "Differential Geometry": case "Functional Analysis":
          case "R": case "MATLAB": case "Fluid Dynamics": case"Fluidodinamica": case "Group Theory for Mathematical Modeling": case "Genetic Algorithms": case "Algoritmi Genetici": case "Simulated Annealing": case "Reinforcement Learning":
          case"Metropolis Algorithm": case "Algoritmo Metropolis":
            return 'Studied & Taught';
          case"General Relativity": case "Lie Groups and Lie algebras": case "Portfolio Management": case "Entropy Based Allocation and Advanced Allocation": case "Asset Allocation": case "Portfolio Optimization":  case "Quantitative Trading Strategies": case "Statistical Arbitrage":
          ...
          case "Econometrics": case "Black & Scholes Equations": case "Pricing of Derivatives": case "Modern Portfolio Theory": case "Monte Carlo Simulation in Finance": case "Investment Decisions": case "Portfolio Selection": case "Risk-based Strategies": case "Risk Parity": case "Maximum Diversification Portfolio": case "Trading (Equity-Commodities-Forex-Futures)": case "Risk Management": case "Alternative Assets (Real Estate-Private Equity-Hedge Funds)": case "Credit":
          case "Currency": case "Commodities": case "Dynamic Portfolio Management": case "Quantitative Risk Management": case "Machine Learning for Finance":  case "High-Frequency Trading (HFT)": case "Market Making": case "Asset Pricing Models": case "Value at Risk (VaR)": case "Expected Shortfall": case "Multi-Asset Strategies": case "Derivatives Pricing":           case "Econometria": case "Equazioni di Black-Scholes": case "Valutazione dei derivati": case "Gestione del portafoglio": case "Teoria moderna del portafoglio": case "Simulazione Monte Carlo in finanza": case "Decisioni di investimento": case "Selezione del portafoglio": case "Strategie basate sul rischio": case "Risk Parity": case "Portafoglio di massima diversificazione": case "Allocazione basata sull'entropia": case "Allocazione avanzata": 
